...
exports.default = _default;
},{"./Exploration":"Exploration.ts","./Adder":"Adder.ts"}],"main.ts":[function(require,module,exports) {
"use strict";
...
var canvas1 = createCanvas(600, 400);
document.getElementById('1').appendChild(canvas1); // Explorations

var adderExploration = createExploration('1', 640, 480, _AdderExploration.default);
var multiplierExploration = createExploration('2', 640, 480, _MultiplierExploration.default);

function renderLoop() {
  adderExploration.render();
  multiplierExploration.render();
